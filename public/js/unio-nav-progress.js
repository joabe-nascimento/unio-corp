...
(function () {
    ...
    function ensureBar() {
        ...
        bar.className = 'unio-nav-progress';
    ...
    function mount() {
        ...
        el.classList.remove('unio-nav-progress--done');
        el.classList.add('unio-nav-progress--active');
        progress = 0.08;
        el.style.width = (progress * 100) + '%';
    }

    function setProgress(value) {
        if (!bar || !bar.classList.contains('unio-nav-progress--active')) {
            return;
        }
    ...
    function finish() {
        ...
        bar.style.width = '100%';
        bar.classList.add('unio-nav-progress--done');
        bar.classList.remove('unio-nav-progress--active');
