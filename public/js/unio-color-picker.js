/**
 * Unio Color Picker — presets + input nativo type=color
 */
(function () {
    'use strict';
    ...
    function scan() {
        document.querySelectorAll('[data-unio-color-picker]').forEach(init);
    }

    window.UnioColorPicker = { init: init, refresh: scan, normalize: normalize };
    ...
    document.addEventListener('unio-offcanvas-opened', scan);
})();
