...
final class PosOperatorioAgendaController extends AbstractController
{
    ...
    public function novo(Request $request): Response
    {
        ...
        return $this->render('modules/pos-operatorio/agenda/form.html.twig', [
            ...
            'medicos' => $this->agenda->listMedicos($empresa),
            'salas' => $this->agenda->listSalas($empresa),
            'profissionais' => $this->agenda->listProfissionais($empresa),
            'procedimentos' => $this->agenda->listProcedimentos($empresa),
            'statuses' => ClinicAgendamento::STATUSES,
            'status_labels' => ClinicAgendaService::statusLabels(),
    ...
    public function editar(int $id, Request $request): Response
    {
        ...
        return $this->render('modules/pos-operatorio/agenda/form.html.twig', [
            ...
            'prefill' => [
                ...
                'sala_id' => $agendamento->getSala()?->getId(),
                'profissional_id' => $agendamento->getProfissional()?->getId(),
                'procedimento_id' => $agendamento->getProcedimento()?->getId(),
                'inicio' => $agendamento->getInicio()->format('Y-m-d H:i'),
                'fim' => $agendamento->getFim()->format('Y-m-d H:i'),
    ...
    private function parseFormData(Request $request): array
    {
        ...
        return [
            ...
            'sala_id' => RequestInts::positiveOrNull($request->request->get('sala_id')),
            'profissional_id' => RequestInts::positiveOrNull($request->request->get('profissional_id')),
            'procedimento_id' => RequestInts::positiveOrNull($request->request->get('procedimento_id')),
            'inicio' => $inicio,
            'fim' => $fim,
