  ...
  public const SECTIONS = [
    ...
    public const MODULES = [
        ...
        [
            ...
            'status' => 'beta',
            'empty_title' => 'Motor de prazos ativo',
            'empty_text' => 'Agenda fatal com alertas em cascata D-7, D-3, D-1 e vencido — notificação na plataforma, WhatsApp Meta e e-mail configurável.',
            'features' => [
                'Cadastro manual de prazos fatais e diligências',
                'Semáforo crítico (48h) e fila de prioridades',
                'Alertas em cascata: D-7, D-3, D-1, hoje e vencido',
                'WhatsApp Meta e e-mail por escritório',
                'Integração com publicações (prazo automático pós-triagem)',
                'SLA de cumprimento no Analytics de carteira',
            ],
            'capabilities' => [
            ...
            'roadmap' => [
                ['phase' => 'Q3', 'title' => 'Motor de prazos ✅', 'items' => ['Cadastro manual ✅', 'Fila crítica ✅', 'Alertas básicos ✅']],
                ['phase' => 'Q4', 'title' => 'Automação ✅', 'items' => ['Publicações → prazo ✅', 'WhatsApp + e-mail ✅', 'Cron alertas ✅']],
            ],
        ...
        [
            ...
            'status' => 'beta',
            'empty_title' => 'Gestão de clientes do escritório',
            'empty_text' => 'Cadastro PF/PJ com KPIs de carteira, segmentação Premium/Standard, busca e vínculo com processos. Propostas, funil comercial e NPS seguem no roadmap.',
            'features' => [
                'Cadastro completo PF/PJ com documento, e-mail, telefone e área de atuação',
                'Listagem com KPIs: total, Premium, Standard e processos ativos na carteira',
                'Busca por nome, e-mail ou documento e filtro por segmento Premium/Standard',
                'Ficha do cliente com processos vinculados e valor em carteira',
                'Banner dinâmico com saudação e botão "Perguntar à Sasha"',
                'Funil lead → proposta → contrato de honorários (em desenvolvimento)',
                'Portal do cliente com convite por e-mail (em desenvolvimento)',
            ],
            'capabilities' => [
                ['icon' => 'fa-building', 'title' => 'Carteira 360°', 'text' => 'KPIs executivos e visão consolidada de processos ativos por cliente.'],
                ['icon' => 'fa-gem', 'title' => 'Premium / Standard', 'text' => 'Segmentação da carteira com filtro rápido e SLA diferenciado.'],
                ['icon' => 'fa-robot', 'title' => 'Sasha integrada', 'text' => 'Priorize clientes e carteira com o copiloto jurídico direto na listagem.'],
            ],
            'roadmap' => [
                ['phase' => 'Q3', 'title' => 'Base ✅', 'items' => ['Cadastro PF/PJ ✅', 'Listagem e busca ✅', 'KPIs de carteira ✅', 'Vínculo com processos ✅']],
                ['phase' => 'Q4', 'title' => 'Carteira ✅', 'items' => ['Segmentação Premium/Standard ✅', 'Ficha do cliente ✅', 'Integração Sasha ✅', 'Hero padronizado ✅']],
                ['phase' => '2027', 'title' => 'Comercial', 'items' => ['Propostas de honorários', 'Funil advocacia', 'NPS cliente', 'KYC e conflito de interesses']],
            ],
        ...
        [
            ...
            'status' => 'beta',
            'empty_title' => 'Portal do cliente ativo',
            'empty_text' => 'Área exclusiva com timeline de processos, documentos compartilhados e convite seguro por link.',
            'features' => [
                'Timeline de andamentos em linguagem simples',
                'Convite por link com validade de 30 dias',
                'Documentos compartilhados (visível no portal)',
                'Visão dos processos vinculados ao cliente',
            ...
            'roadmap' => [
                ['phase' => 'Q4', 'title' => 'MVP portal ✅', 'items' => ['Login + convite ✅', 'Timeline ✅', 'Docs compartilhados ✅']],
            ],
        ...
        [
            ...
            'status' => 'beta',
            'empty_title' => 'GED jurídico ativo',
            'empty_text' => 'Repositório por processo com indexação RAG persistente — a Sasha conhece as peças do escritório.',
            'features' => [
                'Upload por processo e categoria (petição, contrato, parecer)',
                'Indexação RAG automática no JurisFlow (Sasha)',
                'Rastreamento de sincronização com hash (resync inteligente)',
                'Compartilhamento seguro via Portal do Cliente',
                'Busca semântica em peças similares',
            ],
            'capabilities' => [
                ['icon' => 'fa-magnifying-glass', 'title' => 'Busca semântica', 'text' => 'Encontre cláusulas e trechos via Sasha em toda a base do escritório.'],
            ],
            'roadmap' => [
                ['phase' => 'Q3', 'title' => 'Repositório ✅', 'items' => ['Upload ✅', 'Categorias ✅', 'Vínculo processo ✅']],
                ['phase' => 'Q4', 'title' => 'IA ✅', 'items' => ['RAG persistente ✅', 'Resync cron ✅', 'Portal compartilhado ✅']],
            ],
        ...
        [
            ...
            'status' => 'beta',
            'empty_title' => 'Honorários ativos',
            'empty_text' => 'Timesheet por processo com receita mensal e geração de títulos de cobrança integrada ao Analytics.',
            'features' => [
                'Apontamento de horas por processo/cliente',
                'Resumo por advogado com taxa de êxito',
                'Receita mensal no Analytics de carteira',
                'Geração de títulos de cobrança a partir do timesheet',
                'Integração com régua de cobrança WhatsApp',
            ],
            'capabilities' => [
                ['icon' => 'fa-calculator', 'title' => 'Calculadora OAB', 'text' => 'Sasha calcula honorários com base na tabela e no valor da causa.'],
            ],
            'roadmap' => [
                ['phase' => 'Q4', 'title' => 'Financeiro jurídico ✅', 'items' => ['Timesheet ✅', 'Receita Analytics ✅', 'Cobrança ✅']],
            ],
        ...
        [
            ...
            'status' => 'beta',
            'empty_title' => 'Cobrança jurídica ativa',
            'empty_text' => 'Títulos de honorários com aging, régua WhatsApp e KPIs de recebimento no Analytics.',
            'features' => [
                'Aging de honorários em aberto (0-30, 31-60, 61-90, 90+)',
                'Régua de cobrança por WhatsApp Meta',
                'Geração automática a partir do timesheet',
                'Marcação de pagamento e cancelamento',
                'Recebimentos e inadimplência no Analytics',
            ],
            'capabilities' => [
                ['icon' => 'fa-chart-pie', 'title' => 'Previsão de caixa', 'text' => 'Projete recebimentos por carteira e área de atuação.'],
            ],
            'roadmap' => [
                ['phase' => 'Q4', 'title' => 'Recebíveis ✅', 'items' => ['Títulos ✅', 'WhatsApp ✅', 'Aging Analytics ✅']],
            ],
            'integrations' => ['Asaas', 'WhatsApp Meta'],
