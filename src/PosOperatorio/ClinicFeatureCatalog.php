...
final class ClinicFeatureCatalog
{
    ...
    public static function integrations(): array
    {
        return [
            ...
            ['id' => 'contas', 'nome' => 'Contas / a receber', 'status' => 'active', 'desc' => 'Contas abertas, KPIs a receber/recebido, pago ou cortesia.', 'route' => 'app_pos_operatorio_contas', 'route_label' => 'Abrir contas'],
