...
final class StudioModuleNewsService
{
    ...
    private function queryForModule(string $moduleId): string
    {
        return match ($moduleId) {
            ...
            'pacientes' => 'saúde pacientes hospitalar acompanhamento',
            'sala-critica' => 'UTI hospitalar enfermagem monitoramento',
            'carteirinha-digital' => 'plano de saúde beneficiário digital',
            'guia-medico' => 'medicina orientação paciente saúde',
            'alertas' => 'triagem hospitalar emergência saúde',
            'relatorios-lgpd' => 'LGPD privacidade dados saúde',
