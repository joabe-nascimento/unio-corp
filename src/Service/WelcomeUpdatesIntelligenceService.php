...

{
    ...
    private const CHANGELOG = [
        ...
        [
            ...
            'title' => 'Novos núcleos no catálogo',
        ...
        [
            ...
            'summary' => 'Membros, equipes, organograma e avaliações no Núcleo de Operações.',
            ...
            if ($this->navigation->showModuloRh($user)) {
                ...
                if ($admissoes + $ferias + $comunicados > 0 && $bullets !== []) {
                    ...
                    $updates[] = $this->update(
                        ...
                        summary: 'Indicadores reais do Núcleo de Operações e Talentos nesta área de trabalho.',
