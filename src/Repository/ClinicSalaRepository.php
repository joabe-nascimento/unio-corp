...
/** @extends ServiceEntityRepository<ClinicSala> */
class ClinicSalaRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, ClinicSala::class);
    }

    public function findOneByEmpresa(Empresa $empresa, int $id): ?ClinicSala
    {
